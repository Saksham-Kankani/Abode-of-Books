          ...
          <div className='navbar-end space-x-3'>
            ...
            <div className='hidden md:block'>
              <label className="border px-3 py-2 rounded-md flex items-center gap-2">
                <input type="text" className={`grow outline-none bg-base-200 dark:bg-slate-900 dark:text-white ${sticky ? "bg-base-200 dark:bg-slate-600 dark:text-white" : "bg-white"}`} placeholder="Search" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  fill="currentColor"
            ...
            {authUser ? <Logout /> :
              <div >
                <a className="bg-black text-white px-3 py-2 rounded-md cursor-pointer" onClick={() => document.getElementById("my_modal_3").showModal()}>Login</a>
                <Login />
              </div>
            }
          </div>
